...
<asp:Content ID="body" ContentPlaceHolderID="body" runat="server">
      ...
      <ul class="page-breadcrumb">
       ...
       <li>
           <span><a href="<%= ResolveUrl("~/Question/Questiondetail.aspx?ID="+Request.QueryString["QID"]) %>">คำถาม</a></span>
       </li>
     </ul>
         </div>
     <br />
   ...
   <div class="row">
       <div class="col-md-12">
           ...
           <div class="portlet-body">
               <div class="row">
                    <div class="col-md-8 ">
                        <div class="col-sm-2"><span class="pull-right">คำถาม </span></div>
                        <div class="col-sm-6">
                  ...
                  <div class="col-md-8 ">
                   ...
                   <div class="col-md-8 ">
                        <div class="col-sm-2"><span class="pull-right">ชุดที่/บทที่</span></div>
                        <div class="col-sm-6">
                            <span class="pull-left">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>คำตอบ
               </div>
               <div class="tools">
                    <a  class="" data-controls-modal="mdAdd" data-toggle="modal"   href="#mdAdd" >
                        <i class="fa fa-plus"> </i> <span>เพิ่ม</span>
                     </a>
                </div>
           </div>
           <div class="portlet-body">
             <div class="table-responsive">
              <asp:GridView ID="gvDP" runat="server" class="table table-striped" AutoGenerateColumns="False" DataSourceID="sqlDP"  AllowPaging="True" AllowSorting="True" ShowFooter="false" PageSize="20" BackColor="White" BorderColor="White" BorderStyle="None" BorderWidth="0px" CellPadding="3" HeaderStyle-BackColor="#006699">
                    <Columns>
                        <asp:BoundField DataField="SNO" HeaderText="ลำดับ" SortExpression="UserID" HeaderStyle-ForeColor="White"/>
                        <asp:BoundField DataField="Question_data" HeaderText="คำตอบ" SortExpression="UserID" HeaderStyle-ForeColor="White"/>
                        <asp:ImageField DataImageUrlField="cfilename" DataImageUrlFormatString="/Questionpic/{0}" HeaderText="ภาพ" NullImageUrl="~/assets/images/blank.png">
                        <ControlStyle Height="150px" Width="150px" />
                        </asp:ImageField>
                        <asp:BoundField DataField="Iscorrect" HeaderText="เป็นคำตอบที่ถูกต้อง" HeaderStyle-ForeColor="White"/>
                        <asp:BoundField DataField="Detail_answer" HeaderText="รายละเอียด" HeaderStyle-ForeColor="White"/>
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT ROW_NUMBER() OVER (ORDER BY (SELECT 100)) AS SNO ,[id],[Question_detail_id],[Question_data],[Ispic] ,[Piclocation],[Iscorrect] ,[Detail_answer], [filename], CONCAT([id],'/',[filename]) AS cfilename  FROM [Question_data] where Question_detail_id=@Question_detail_id and Active='1'"  >
                <SelectParameters>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">สร้างคำตอบ</h4>
                     <h2 id="txtFname">
                        <label for="fullname">คำตอบ</label>
                        <input type="text" class="form-control" id="txtNName" name ="txtNName" placeholder="" runat="server">
                    </h2>
                     <h2 id="H1">
                        <label for="fullname">ตัวเลือกนี้เป็นคำตอบที่ถูกต้องหรือไม่</label>
                         <asp:CheckBox class="form-control" ID="CheckBox1" runat="server" />
                     </h2>
                     <h2 id="H2">
                        <label for="fullname">รายละเอียด</label>
                        <input type="text" class="form-control" id="detailanswer" name ="txtNName" placeholder="" runat="server">
                    </h2>
                </div>
