...
namespace newweb.QA
{
  public class Activities : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_activities] ([projectid],[activities],[Active],[Responsible],[PassScore],[Createdate]) VALUES('" + str1 + "','" + this.txtNName.Value + "','1','" + str2 + "','" + this.Text1.Value + "','" + (object) DateTime.Now + "')";
      cconnect.sqlCmd(sql);
    }
