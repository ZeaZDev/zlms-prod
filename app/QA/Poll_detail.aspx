<%@ Page Language="C#" MasterPageFile="~/Police.Master"   AutoEventWireup="true" CodeBehind="Poll_detail.aspx.cs" Inherits="newweb.QA.Poll_detail" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>List of Quesstion poll
               </div>
               <div class="tools">
