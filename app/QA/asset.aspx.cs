  ...
  public class asset : Page
  {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index < this.gvDP.Rows.Count; ++index)
      {
        ...
        this.addUser((index + 1).ToString(), text);
      }
    }
    ...
    private void addUser1()
    {
      ...
      string sql = "delete QA_result where Projectid='" + str + "'";
      cconnect.sqlCmd(sql);
    }
    ...
    private void addUser(string filename, string filepath)
    {
      ...
      string sql = "INSERT INTO QA_result ([Projectid],[standard_detail_id],[Score],[Createdate]) VALUES('" + str + "','" + filename + "','" + filepath + "','" + (object) DateTime.Now + "')";
      cconnect.sqlCmd(sql);
    }
