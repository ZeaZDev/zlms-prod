<%@ Page Language="C#" MasterPageFile="~/Police.Master"   AutoEventWireup="true" CodeBehind="Standard_detail.aspx.cs" Inherits="newweb.QA.Standard_detail" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>List of ตัวบ่งชี้
               </div>
               <div class="tools">
                        ...
                        <asp:TemplateField HeaderText="ตัวบ่งชี้">
                            <ItemTemplate>
                                 <asp:HyperLink ID="lnk" runat="server" Target="_self" Text='<%# Eval("Standard_detail") %>'
                                            NavigateUrl='<%# "Standard_detail_add.aspx?ID=" +Eval("ID") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField> 
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,Standard_detail,[Weight] FROM [QA_standard_detail] c where Active='1' and Standardid=@projectid"  >
                <SelectParameters>
