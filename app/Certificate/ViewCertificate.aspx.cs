...
// Type: newweb.Certificate.ViewCertificate
...
{
  public class ViewCertificate : Page
  {
    ...
    protected void ShowMessage(string Message, ViewCertificate.MessageType type)
    {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
      ...
      this.Response.Redirect("Certificatedetail_user.aspx?id=" + linkButton.CommandArgument.ToString().Trim() + "&courseid=" + str);
    }
