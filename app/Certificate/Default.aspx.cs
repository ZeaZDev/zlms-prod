...
namespace newweb.Certificate
{
  public class Default : Page
  {
    ...
    private void addUser(string user, string pass)
    {
      ...
      string sql = "INSERT INTO [Certificate] ([Certificatename],[CertificateDesp],[Active],[Createdate],[Createby],[Course_id]) VALUES('" + this.txtNName.Value + "','" + this.txtFullname.Value + "','1','" + (object) DateTime.Now + "','1','" + str + "')";
      cconnect.sqlCmd(sql);
    }
