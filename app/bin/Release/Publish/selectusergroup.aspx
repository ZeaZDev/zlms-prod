<%@ Page Language="C#" MasterPageFile="~/Police.Master" AutoEventWireup="true" CodeBehind="selectusergroup.aspx.cs" Inherits="newweb.selectusergroup" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT c.ID,c.[userid],m.UserGroupname FROM [useringroup] c inner join  usergroup m on m.id=c.usergroupid where C.userid=@userid and c.active='1' "  >
                <SelectParameters>
