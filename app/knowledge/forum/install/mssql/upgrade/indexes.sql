...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Buddy_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Buddy]'))
...
if exists(select top 1 1 from sys.indexes where name=N'IX_Name' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Registry]'))
	drop index [IX_Name] ON [{databaseOwner}].[{objectQualifier}Registry]
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Registry_Name' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Registry]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}PollVote_RemoteIP' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}PollVote]'))
 CREATE  INDEX [IX_{objectQualifier}PollVote_RemoteIP] ON [{databaseOwner}].[{objectQualifier}PollVote]([RemoteIP])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}PollVote_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}PollVote]'))
 CREATE  INDEX [IX_{objectQualifier}PollVote_UserID] ON [{databaseOwner}].[{objectQualifier}PollVote]([UserID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}PollVote_PollID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}PollVote]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}UserGroup_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}UserGroup]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Message_TopicID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Message]'))
 CREATE  INDEX [IX_{objectQualifier}Message_TopicID] ON [{databaseOwner}].[{objectQualifier}Message]([TopicID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Message_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Message]'))
 CREATE  INDEX [IX_{objectQualifier}Message_UserID] ON [{databaseOwner}].[{objectQualifier}Message]([UserID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Message_Flags' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Message]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Topic_ForumID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Topic]'))
 CREATE  INDEX [IX_{objectQualifier}Topic_ForumID] ON [{databaseOwner}].[{objectQualifier}Topic]([ForumID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Topic_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Topic]'))
 CREATE  INDEX [IX_{objectQualifier}Topic_UserID] ON [{databaseOwner}].[{objectQualifier}Topic]([UserID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Topic_Flags' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Topic]'))
 CREATE  INDEX [IX_{objectQualifier}Topic_Flags] ON [{databaseOwner}].[{objectQualifier}Topic]([Flags])
go

-- {objectQualifier}Forum

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Forum_CategoryID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Forum]'))
 CREATE  INDEX [IX_{objectQualifier}Forum_CategoryID] ON [{databaseOwner}].[{objectQualifier}Forum]([CategoryID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Forum_ParentID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Forum]'))
 CREATE  INDEX [IX_{objectQualifier}Forum_ParentID] ON [{databaseOwner}].[{objectQualifier}Forum]([ParentID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Forum_Flags' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Forum]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}User_Joined' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}User]'))
 CREATE  INDEX [IX_{objectQualifier}User_Joined] ON [{databaseOwner}].[{objectQualifier}User]([Joined])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}User_ProviderUserKey' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}User]'))
 CREATE  INDEX [IX_{objectQualifier}User_ProviderUserKey] ON [{databaseOwner}].[{objectQualifier}User]([ProviderUserKey])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}User_Name' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}User]'))
 CREATE  INDEX [IX_{objectQualifier}User_Name] ON [{databaseOwner}].[{objectQualifier}User]([Name])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}User_UserStyle' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}User]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}ForumAccess_ForumID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}ForumAccess]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}UserPMessage_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}UserPMessage]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Category_BoardID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Category]'))
 CREATE  INDEX [IX_{objectQualifier}Category_BoardID] ON [{databaseOwner}].[{objectQualifier}Category]([BoardID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}Category_Name' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}Category]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}FavoriteTopic_TopicID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}FavoriteTopic]'))
 CREATE  INDEX [IX_{objectQualifier}FavoriteTopic_TopicID] ON [{databaseOwner}].[{objectQualifier}FavoriteTopic]([TopicID])
go

if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}FavoriteTopic_UserID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}FavoriteTopic]'))
...
if not exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}UserAlbumImage_AlbumID' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}UserAlbumImage]'))
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[{databaseOwner}].[{objectQualifier}Thanks]') AND name = N'IX_{objectQualifier}Thanks_MessageID')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[{databaseOwner}].[{objectQualifier}Thanks]') AND name = N'IX_{objectQualifier}Thanks_ThanksFromUserID')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[{databaseOwner}].[{objectQualifier}Thanks]') AND name = N'IX_{objectQualifier}Thanks_ThanksToUserID')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[{databaseOwner}].[{objectQualifier}FavoriteTopic]') AND name = N'IX_{objectQualifier}FavoriteTopic_TopicID')
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[{databaseOwner}].[{objectQualifier}FavoriteTopic]') AND name = N'IX_{objectQualifier}FavoriteTopic_UserID')
