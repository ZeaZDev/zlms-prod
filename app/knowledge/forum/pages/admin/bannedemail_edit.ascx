<%@ Control Language="c#" AutoEventWireup="True"
	Inherits="YAF.Pages.Admin.bannedemail_edit" Codebehind="bannedemail_edit.ascx.cs" %>
<YAF:PageLinks runat="server" ID="PageLinks" />
<YAF:AdminMenu runat="server">
	<table class="content" width="100%" cellspacing="1" cellpadding="0">
		<tr>
			<td class="header1" colspan="2">
				<YAF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_BANNEDEMAIL_EDIT" />
             </td>
		</tr>
        <tr>
		...
		<tr>
			...
			<td class="post" width="50%">
				<asp:TextBox Style="width: 250px" ID="mask" runat="server" MaxLength="255"></asp:TextBox></td>
		</tr>
			<tr>
			<td class="postheader" width="50%">
			...
			<td class="post" width="50%">
				<asp:TextBox Style="width: 250px" ID="BanReason" runat="server" MaxLength="128"></asp:TextBox></td>
		</tr>
		<tr>
