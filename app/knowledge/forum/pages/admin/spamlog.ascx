    ...
    <table class="content" width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <td class="header1" colspan="2">
                <YAF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_SPAMLOG" />
            </td>
        </tr>
        <tr class="header2">
            <td>
    ...
    <table class="content" width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <td class="header1" colspan="8">
                <YAF:LocalizedLabel ID="LocalizedLabel6" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_SPAMLOG" />
            </td>
        </tr>
