<%@ Control Language="C#" AutoEventWireup="true" Inherits="YAF.Pages.Admin.bannedemail_import" Codebehind="bannedemail_import.ascx.cs" %>
	...
	<table class="content" cellspacing="1" cellpadding="0" width="100%">
		<tr>
			<td class="header1" colspan="2">
              <YAF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER" LocalizedPage="ADMIN_BANNEDEMAIL_IMPORT" />
            </td>
		</tr>
        <tr>
