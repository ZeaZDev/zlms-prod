<%@ Page Language="C#" MasterPageFile="~/Police.Master" AutoEventWireup="true" CodeBehind="Poll_detail1.aspx.cs" Inherits="newweb.QA_NEW.Poll_detail1" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>รายการคำถาม ตอนที่ ๑
               </div>
               <div class="tools">
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,[Standard_detail] FROM [QA_Poll_detail1] c where Active='1' and pollid=@projectid"  >
                <SelectParameters>
