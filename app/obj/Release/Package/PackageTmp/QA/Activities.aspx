<%@ Page Language="C#" MasterPageFile="~/Police.Master"  AutoEventWireup="true" CodeBehind="Activities.aspx.cs" Inherits="newweb.QA.Activities" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>รายชื่อโครงการ
               </div>
               <div class="tools">
             ...
             <div class="table-responsive">
              <asp:GridView ID="gvDP" runat="server" class="table table-striped" AutoGenerateColumns="False" DataSourceID="sqlDP"  ShowFooter="false" >
                    <Columns>
                        ...
                        <asp:BoundField DataField="Name" HeaderText="Responsesibilities" />  
                        <asp:TemplateField>
                            <ItemTemplate>
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  q.[id] ,q.[activities],q.[PassScore],u.[Name] FROM [QA_activities] q inner join List_main u on u.id =q.Responsible where q.Active='1' and q.[projectid]=@projectid"  >
                 <SelectParameters>
