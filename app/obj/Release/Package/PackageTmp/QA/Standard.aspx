<%@ Page Language="C#" MasterPageFile="~/Police.Master"   AutoEventWireup="true" CodeBehind="Standard.aspx.cs" Inherits="newweb.QA.Standard" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>List of กลุ่มตัวบ่งชี้
               </div>
               <div class="tools">
           ...
           <div class="portlet-body">
             <div class="table-responsive">
              <asp:GridView ID="gvDP" runat="server" class="table table-striped" AutoGenerateColumns="False" DataSourceID="sqlDP"  ShowFooter="false" >
                    <Columns>
                        <asp:TemplateField HeaderText="กลุ่มตัวบ่งชี้">
                            <ItemTemplate>
                                 <asp:HyperLink ID="lnk" runat="server" Target="_self" Text='<%# Eval("qa_standard") %>'
                                            NavigateUrl='<%# "Standard_detail.aspx?ID=" +Eval("ID") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        <asp:TemplateField>
                            <ItemTemplate>
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,qa_standard FROM [QA_standard] c where Active='1' and qaindicator=@qaindicator"  >
                <SelectParameters>
                         <asp:QueryStringParameter Name="qaindicator" QueryStringField="qaindicator" />                      
                   </SelectParameters>
                </asp:SqlDataSource>
       </div>                             
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Enter QA Indicator </h4>
                     <h2 id="txtFname">
                        <label for="fullname">Indicator  Group Name </label>
