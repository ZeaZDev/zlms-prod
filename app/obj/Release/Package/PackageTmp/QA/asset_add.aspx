<%@ Page Language="C#" MasterPageFile="~/Police.Master" AutoEventWireup="true" CodeBehind="asset_add.aspx.cs" Inherits="newweb.QA.asset_add" %>
                    ...
                    <Columns>
                         ...
                         <asp:TemplateField HeaderText="ตัวบ่งชี้">
                            <ItemTemplate>
                                 <asp:HyperLink ID="lnk" runat="server" Target="_self" Text='<%# Eval("Standard_detail") %>'
                                            NavigateUrl='<%# "asset_add_file.aspx?ID=" +Eval("ID") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                 ...
                                 <asp:LinkButton runat="server" ID="LinkButton1" class="btn btn-success btn-circle btn-sm"  CommandArgument='<%# Eval("ID") %>' OnClick="Button4_Click">
...
left join QA_Indicator qi on qi.id=qsd.qaindicator left join QA_project qp on qp.id=qi.projectid left join QA_result_detail rd on rd.standard_detail_id=qd.id where qi.projectid =@projectid"  >
                   <SelectParameters>
