<%@ Page Language="C#" MasterPageFile="~/Police.Master"  AutoEventWireup="true" CodeBehind="activities_detail.aspx.cs" Inherits="newweb.QA.activities_detail" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,[Activitiesdetail],CASE  WHEN [Passascore] ='1' then 'pass' ELSE 'no result' END   as passscore FROM [QA_activities_detail] c where Active='1'"  >
                </asp:SqlDataSource>
       </div>                             
