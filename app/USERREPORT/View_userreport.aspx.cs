...
// Type: newweb.USERREPORT.View_userreport
...
{
  public class View_userreport : Page
  {
    protected Button bnExport;
    protected GridView gvDP;
    protected SqlDataSource sqlDP;

    protected void ShowMessage(string Message, View_userreport.MessageType type)
    {
    ...
    {
      GridViewExportUtil.Export1("Userreport_" + DateTime.Now.ToString("yyyyMMddHHmm") + ".xls", this.gvDP);
    }
