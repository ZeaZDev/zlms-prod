...
namespace newweb.Course
{
  public class Coursedetail : Page
  {
    ...
    private void addUser(string user, string pass)
    {
      ...
      string sql = "INSERT INTO [Class] ([CourseID],[ClassName],[ClasssDesp],[UserID],[CreatedDate],[Active],[ModifyDate],[Modifyby]) VALUES('" + str + "','" + this.txtNName.Value + "','" + this.txtFullname.Value + "','1','" + (object) DateTime.Now + "','1','" + (object) DateTime.Now + "','1')";
      cconnect.sqlCmd(sql);
    }
