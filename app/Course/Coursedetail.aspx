...
<asp:Content ID="body" ContentPlaceHolderID="body" runat="server">
   ...
   <div class="row">
       <div class="col-md-12">
           ...
           <div class="portlet-body">
               <div class="row">
                   ...
                   <div class="col-md-12">
                      <div class="col-md-8">
                          <div class="col-sm-2"><span class="pull-right">คำอธิบาย</span></div>
                        <div class="col-sm-6">
                            <span class="pull-left">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>หมวดวิชา ของ <asp:Label ID="Coursename" runat="server" Text="Label"></asp:Label>
               </div>
               <div class="tools">
                    <a  class="" data-controls-modal="mdAdd" data-toggle="modal"   href="#mdAdd" >
                        <i class="fa fa-plus"> </i> <span>เพิ่มหมวดวิชา</span>
                     </a>
                </div>
           </div>
           <div class="portlet-body">
             <div class="table-responsive">
              <asp:GridView ID="gvDP" runat="server" class="table table-striped" AutoGenerateColumns="False" DataSourceID="sqlDP"  AllowPaging="True" AllowSorting="True" ShowFooter="false" PageSize="20" BackColor="White" BorderColor="White" BorderStyle="None" BorderWidth="0px" CellPadding="3" HeaderStyle-BackColor="#006699">
                    <Columns>
                        <asp:TemplateField HeaderText="หมวดวิชา" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">เพิ่มหมวดวิชา</h4>
                     <h2 id="txtFname">
