<%@ Page Language="C#" MasterPageFile="~/Police.Master"  AutoEventWireup="true" CodeBehind="indicator.aspx.cs" Inherits="newweb.QA_NEW.indicator" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               ...
               <div class="tools">
                    <a  class="" data-controls-modal="mdAdd" data-toggle="modal"   href="#mdAdd" >
                        <i class="fa fa-plus"> </i> <span>เพิ่มกลุ่มตัวบ่งชี้</span>
                     </a>
                </div>
           </div>
                        ...
                        <asp:TemplateField HeaderText="กลุ่มตัวบ่งชี้">
                            <ItemTemplate>
                                 <asp:HyperLink ID="lnk" runat="server" Target="_self" Text='<%# Eval("indicator") %>'
                                            NavigateUrl='<%# "Standard.aspx?ID=" +Eval("ID") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        <asp:TemplateField>
                            <ItemTemplate>
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,indicator FROM [QA_Indicator] c where Active='1' and projectid=@projectid"  >
                <SelectParameters>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">เพิ่มกลุ่มตัวบ่งชี้</h4>
                     <h2 id="txtFname">
                        <label for="fullname">ชื่อกลุ่มตัวบ่งชี้ </label>
