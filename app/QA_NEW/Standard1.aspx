           ...
           <div class="portlet-title">
               ...
               <div class="tools">
                    <a  class="" data-controls-modal="mdAdd" data-toggle="modal"   href="#mdAdd" >
                        <i class="fa fa-plus"> </i> <span>สร้างหน่วยงานมาตรฐาน 1</span>
                     </a>
                </div>
           </div>
           <div class="portlet-body">
             <div class="table-responsive">
              <asp:GridView ID="gvDP" runat="server" class="table table-striped" AutoGenerateColumns="False" DataSourceID="sqlDP"  ShowFooter="false" >
                    <Columns>
                        <asp:TemplateField HeaderText="หน่วยงาน" ItemStyle-Width="50%">
                            <ItemTemplate>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"> สร้างหน่วยงานมาตรฐาน 1</h4>
                     <h2 id="txtFname">
                        <label for="fullname">ชื่อหน่วยงาน</label>
