...
namespace newweb.QA_NEW
{
  public class survey_list : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_Poll_ID] ([Pollname] ,[Active],[Createdate],[Projectid],[rollgroup]) VALUES('" + this.txtNName.Value + "','1','" + (object) DateTime.Now + "','','" + this.Session["group"].ToString() + "')";
      cconnect.sqlCmd(sql);
    }
