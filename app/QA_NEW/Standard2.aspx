<%@ Page Language="C#" MasterPageFile="~/Police.Master"  AutoEventWireup="true" CodeBehind="Standard2.aspx.cs" Inherits="newweb.QA_NEW.Standdard2" %>
   ...
   <div class="row">
       ...
       <div class="portlet box green">
           <div class="portlet-title">
               <div class="caption">
                    <i class="fa fa-cogs"></i>รายชื่อหน่วยงานมาตรฐาน 2
               </div>
               <div class="tools">
           ...
           <asp:SqlDataSource ID="sqlDP" runat="server" ConnectionString="<%$ ConnectionStrings:cdas_conn %>"
                    SelectCommand="SELECT  [id] ,[Project] FROM [QA_project] c where Active='1' and Stdid='2'"  >
                </asp:SqlDataSource>
       </div>                             
