...
// Type: newweb.QA_NEW.Poll_detail
...
namespace newweb.QA_NEW
{
  public class Poll_detail : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_Poll_detail] ([Standard_detail],[pollid] ,[Active],[Createdate],[Weight]) VALUES('" + this.txtNName.Value + "','" + str + "','1','" + (object) DateTime.Now + "','" + this.Text1.Value + "')";
      cconnect.sqlCmd(sql);
    }
