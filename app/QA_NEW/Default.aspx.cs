  ...
  public class Default : Page
  {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
      ...
      if (linkButton.CommandArgument.ToString().Trim().Length <= 0)
        return;
      this.Response.Redirect("Project_edit.aspx?id=" + linkButton.CommandArgument.ToString().Trim());
    }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
      ...
      if (linkButton.CommandArgument.ToString().Trim().Length <= 0)
        return;
      this.Response.Redirect("setpoll.aspx?id=" + linkButton.CommandArgument.ToString().Trim());
    }
    ...
    protected void bnAdduser_Click(object sender, EventArgs e)
    {
      ...
      {
        this.ShowMessage("Project Name can not be blank", Default.MessageType.Error);
      }
      else
      {
        this.addUser(this.txtNName.Value);
        this.ShowMessage("Project Name  " + this.txtNName.Value + " is added", Default.MessageType.Success);
        this.sqlDP.DataBind();
        this.gvDP.DataBind();
        this.clearAddnew();
      }
    ...
    {
      new CConnect().sqlCmd("INSERT INTO [QA_project ] ([Project] ,[Active],[Createdate]) VALUES('" + this.txtNName.Value + "','1','" + (object) DateTime.Now + "')");
    }
