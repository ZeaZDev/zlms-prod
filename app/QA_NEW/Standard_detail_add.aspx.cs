...
namespace newweb.QA_NEW
{
  public class Standard_detail_add : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_standard_detail_add] ([Standard_detail],[Standardid] ,[Active],[Createdate],[Weight]) VALUES('" + this.txtNName.Value + "','" + str + "','1','" + (object) DateTime.Now + "','" + this.Text1.Value + "')";
      cconnect.sqlCmd(sql);
    }
