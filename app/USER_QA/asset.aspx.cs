...
namespace newweb.USER_QA
{
  public class asset : Page
  {
    ...
    private void addUser1()
    {
      ...
      string sql = "delete QA_result1 where Projectid='" + str + "'";
      cconnect.sqlCmd(sql);
    }
    ...
    private void addUser(string filename, string filepath)
    {
      ...
      string sql = "INSERT INTO QA_result1 ([Projectid],[standard_detail_id],[Score],[Createdate]) VALUES('" + str + "','" + filename + "','" + filepath + "','" + (object) DateTime.Now + "')";
      cconnect.sqlCmd(sql);
    }
